    ...
    return(
        ...
        <div className="menuBackground mainMenu">
            ...
            <div className="mainSlave">
                ...
                {(perm['sysAdmin']===1|perm["userAdmin"]===1|perm["userGlobal"]===1)?<HrefClass3 text="Nutzerverwaltung" noUnderline={true} action='/usermgmt'/>:<></>}
                ...
                {(perm['sysAdmin']===1|perm["pluginAdmin"]===1|perm["pluginGlobal"]===1)?<HrefClass3 text="Pluginkonfiguration" noUnderline={true} action='/plugigmgmt'/>:<></>}
...
function LogOut(){
    ...
    return(
        <div className={(warn)? "logoutContainer href Class3 zeroTB":"logoutContainer href Class3 zeroTB"}>
