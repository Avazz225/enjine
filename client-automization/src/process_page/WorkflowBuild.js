...
class WorkflowBuilder extends React.Component{
    ...
    componentDidMount(){
        let data = {"program_plugin": {"plugins": [{"id": 6, "name": "gmail", "params": {"recipient": null, "CC-recipient": null, "topic": null, "text": null, "replacementValues": null}}], "programsAndRights": [{"id": 1, "name": "BSP1"}, {"id": 2, "name": "BSP2"}, {"id": 5, "name": "E-Mailsender"}], "relations": [{"id": 14, "pid": 6, "prid": 5, "description": "Sendet eine Email an den Empfänger"}]}, "appConf": {"initial_pw_duration": 24, "token_duration": 72, "pw_duration": 2160, "old_pw_count": 5, "configurable_specific_properties": ["sad", "testProperty"]}}
